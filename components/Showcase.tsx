        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-header text-cronos-white uppercase leading-tight mb-8">
              ...
              não um remédio{' '}
              <span className="text-cronos-white/30 line-through decoration-cronos-orange decoration-2">prescrevido</span>.
            </h2>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-cronos-charcoal backdrop-blur-sm p-8 bord
