        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
                ...
                <div className="flex gap-8">
                    <div>
                        <span className="block text-4xl font-header text-cronos-white">+37%</span>
                        <span className="text-xs text-black/40 uppercase tracking-widest">Média de ROAS</span>
                    </div>
                    <div>
            ...
            >   
                ...
                <div className="flex justify-between items-center mb-8 relative z-10">
                    <h3 className="font-header text-xl uppercase tracking-widest text-cronos-white/80">Curva de Crescimento</h3>
