        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-header text-cronos-white leading-[1.1] mb-8 uppercase">
              A metodologia validada que já <span className="text-transparent bg-clip-text bg-gradient-to-r from-cronos-white to-gray-400">transformou</span> centenas de restaurantes e <span className="text-cronos-lime drop-shadow-[0_0_15px_rgba(233,18,114,0.4)]">multiplicou seu faturamento</span>.
            </h2>
            
            <div className="w-20 h-1 bg-cronos-orange mb-8" />

            <p className="text-cronos-white/70 text-lg leading-relaxed font-sans mb-6">
              Chega de gastar dinheiro com marketing que não traz retorno. Nossa assessoria é <strong className="text-cronos-white">100% especializada no setor gastronômico</strong>, com um time que vive e respira restaurantes. 
            </p>
            <p className="text-cronos-white/70 text-lg leading-relaxed font-sans mb-12">
              Entendemos suas dores, conhecemos seu público e sabemos exatamente o que funciona para fazer seu negócio crescer de forma <strong className="text-cronos-white">previsível e escalável</strong>.
            </p>
